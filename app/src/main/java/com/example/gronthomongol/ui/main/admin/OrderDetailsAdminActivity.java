    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDelivered.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(OrderDetailsAdminActivity.this);
                ...
                Thread thread = new Thread(new Runnable() {
                    @Override
                    public void run() {
                        currentOrder.updateOrderOnDatabase(OrderDetailsAdminActivity.this, dialog, "delivered");
                    }
                });
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Context context = OrderDetailsAdminActivity.this;
                ...
                alertDialogBuilder.setPositiveButton(positiveButton, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface dialog, int which) {
                        dialog.dismiss();
                        final Dialog waitDialog = new Dialog(OrderDetailsAdminActivity.this);
                        ...
                        Thread thread = new Thread(new Runnable() {
                            @Override
                            public void run() {
                                currentOrder.deleteOrderOnDatabase(OrderDetailsAdminActivity.this, waitDialog);
                            }
                        });
