    ...
    private void Login(final String email, final String password, Boolean stayLoggedIn, final Dialog dialog) {
        Backendless.UserService.login(email, password, new AsyncCallback<BackendlessUser>() {
            ...
            public void handleResponse(BackendlessUser response) {
                ...
                CONSTANTS.RetrieveBookListFromDatabaseInitially(SignInActivity.this, CONSTANTS.getIdLogin(), dialog);    // This is will retrieve the proper offers too
            }
            ...
            public void handleFault(BackendlessFault fault) {
                ...
                if(fault.getCode().equals("3003")){
                    ...
                    CONSTANTS.showErrorDialog(SignInActivity.this, title, message, "Okay", null, 0);
                }
    ...
    private void registerDeviceForNotification(String channel) {
        ...
        Backendless.Messaging.registerDevice(channels, new AsyncCallback<DeviceRegistrationResult>() {
            ...
            public void handleFault(BackendlessFault fault) {
                ...
                Toast.makeText( SignInActivity.this, "Error registering " + fault.getMessage(),
