...
public class requestList extends AppCompatActivity implements RequestlistAdapterRV.OnRequestClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(CONSTANTS.userRequestsCached == null) {
            ...
            final Dialog waitDialog = new Dialog(requestList.this);
        ...
        Backendless.Data.of(Request.class).find(dataQueryBuilder, new AsyncCallback<List<Request>>() {
            ...
            public void handleFault(BackendlessFault fault) {
                ...
                if( fault.getMessage().equals(getString(R.string.connectionErrorMessageBackendless) )) {
                    ...
                    CONSTANTS.showErrorDialog(requestList.this, title, message, "Okay", null, 0);
                }
                else{
                    CONSTANTS.showErrorDialog(requestList.this, "Error Occurred", "Sorry cannot retrieve the request list right now",
                            "Okay", null, 19);
                }
            }
        });
        ...
        alertDialogBuilder.setPositiveButton(positiveButton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(final DialogInterface dialog, int which) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        // TODO
                        CONSTANTS.userRequestsCached.get(position).markAsResolvedAndNotify(requestList.this, waitDialog, requestlistAdapterRV);
                    }
                });
        ...
        alertDialogBuilder.setNegativeButton(negativeButton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        // TODO
                        CONSTANTS.userRequestsCached.get(position).removeRequest(requestList.this, waitDialog, requestlistAdapterRV);
                    }
                });
