...
public class BooklistAdapterRV extends RecyclerView.Adapter<BooklistAdapterRV.MyViewHolder> {
    ...
    public BooklistAdapterRV(List<Book> books_para, Context context, OnBookClickListener onBookClickListener) {
    ...
    @Override
    public BooklistAdapterRV.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
