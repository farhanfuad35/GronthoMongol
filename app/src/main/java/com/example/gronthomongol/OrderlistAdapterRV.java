...
public class OrderlistAdapterRV extends RecyclerView.Adapter<OrderlistAdapterRV.MyViewHolder> {
    ...
    public OrderlistAdapterRV(List<Order> orders_para, Context context, OnOrderClickListener onOrderClickListener) {
    ...
    @Override
    public OrderlistAdapterRV.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
