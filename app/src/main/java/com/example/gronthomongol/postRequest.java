...
public class postRequest extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(postRequest.this);
            ...
            public void onClick(View v) {
                ...
                if(!isEmpty(etName) && !isEmpty(etWriter)) {
                    ...
                    Thread thread = new Thread(new Runnable() {
                        @Override
                        public void run() {
                            request.saveRequestInBackendless(postRequest.this, dialog);
                        }
                    });
